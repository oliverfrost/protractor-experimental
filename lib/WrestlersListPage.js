...
class WrestlersPage extends BasePage {
    ...
    getRowByIndex(index) {
        ...
        return element(by.css(".table-striped tr:nth-child(" + index + ")"));
    }
    ...
    getRecordIdByIndex(num) {
        ...
        return element(by.css(".table-striped tr:nth-child(" + num + ") td:nth-child(1)")).getText();
    }
    ...
    get tabs() {
        return element.all(by.css(".nav-tabs li"));
    }
    ...
    fetchActiveTabText() {
        return element.all(by.css("li.ng-isolate-scope.active")).first().getText()
            .then(function (text) {
